      ...
      boxShadow: '0 5px 10px rgba(104, 165, 254, 0.3)'}}>
        ...
        <Box sx={{ 
          ...
          <Box>
            ...
            <Box>
              <Box key={comment.No} sx={{ display: 'flex', mb: 1 }}>
                <Typography sx={{ fontSize: isMobile ? '14px' : '18px', }}>
                  {comment.Nickname} 
                </Typography>
                <Typography sx={{ fontSize: isMobile ? '14px' : '18px', mx:1}}>
                | 
                </Typography>
                <Typography sx={{ fontSize: isMobile ? '14px' : '18px', }} color="text.secondary">
                  {new Date(comment.Wdate).toLocaleDateString()}
                </Typography>
              </Box>
              
              <Typography sx={{ fontSize: isMobile ? '14px' : '18px', }}>{comment.Comment}</Typography>
              <Divider sx={{ my: 3 }} />
            </Box>
            ))}
          </Box>
